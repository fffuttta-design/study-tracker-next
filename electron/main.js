...
async function applyUpdate(sourcePath, newVersion, _newBuildNum) {
  const script = [
    ...
    '  Write-Host "=====================================" -ForegroundColor Cyan',
    '  Write-Host ""',
    '  Write-Host "[1/3] アプリを終了中..." -ForegroundColor Green',
    ...
    '  Write-Host "    プロセス終了確認 ✓" -ForegroundColor Green',
    `  Write-Host "[2/3] v${newVersion} をコピー中..." -ForegroundColor Yellow`,
    '  Write-Host "  元: $env:ST_SRC" -ForegroundColor Gray',
    '  Write-Host "  先: $env:ST_DST" -ForegroundColor Gray',
    ...
    '  Write-Host "  元フォルダ: $env:ST_SRC" -ForegroundColor Yellow',
    '  Write-Host "  先フォルダ: $env:ST_DST" -ForegroundColor Yellow',
