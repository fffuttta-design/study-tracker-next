...
const styles = StyleSheet.create({
  ...
  tab: { paddingVertical: 6, paddingHorizontal: 14, borderRadius: 20, backgroundColor: '#1f2937' },
  ...
  card: { backgroundColor: '#1f2937', borderRadius: 10, padding: 14, borderLeftWidth: 3, borderLeftColor: '#374151' },
  ...
  category: { fontSize: 11, color: '#9ca3af', backgroundColor: '#374151', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  ...
  cardTitle: { fontSize: 15, fontWeight: '600', color: '#f9fafb', marginBottom: 4 },
  cardTitleDone: { textDecorationLine: 'line-through', color: '#9ca3af' },
  cardContent: { fontSize: 13, color: '#9ca3af', marginBottom: 8 },
  ...
  reviewDotFuture: { backgroundColor: '#374151' },
